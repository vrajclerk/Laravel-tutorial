...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="{{ url('/') }}/customer/create" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="customer_name" name="customer_name" maxlength="60"  >
            </div>
            <div class="mb-3">
                <label for="customer_email" class="form-label">Customer Email</label>
                <input type="email" class="form-control" id="customer_email" name="customer_email" maxlength="100"  >
            </div>
            <div class="mb-3">
    ...
    <div class="container mt-5">
        <h2>{{$title}}</h2>
        <form action="{{ url('/') }}/customer/edit/{$id}" method="post">
            {{-- for dynamic (create,update) --}}
            {{-- <form action="{{ $url}}" method="post"> --}}
            @csrf
            <div class="mb-3">
